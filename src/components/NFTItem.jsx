                ...
                <div className="right w-2/5">
                    <div className="price">
                        ...
                        <div className="currency-with-symbol flex items-center justify-end">
                            ...
                            <p className='text-sm text-Dark font-semibold ml-1'>0.16</p>
                        </div>
                    </div>
